			...
			<div className="w-11/12 flex pt-9">
				<div className="w-7/12">
					...
					<p className="mt-5 text-lg font-thin">
						...
						—regardless if it's in theatres, on TV or available on
						popular streaming services like Netflix, Amazon Prime
						Video, Disney Plus, Apple TV Plus, and fuboTV.
					</p>
					<Link href={'./signup'}><button className="text-white px-5 py-2 rounded-md mt-6 font-bold bg-accountPurple">Sign Up</button></Link>
				</div>
